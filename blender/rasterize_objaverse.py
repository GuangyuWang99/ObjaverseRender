...
if __name__ == "__main__":
    root_folder = "/data/guangyu/aRobotics/data/objaverse/4"
    vis_normal_path = os.path.join(root_folder, 'vis_n')
    os.makedirs(vis_normal_path, exist_ok=True)
    img_path = os.path.join(root_folder, "buffers/images")
    cam_path = os.path.join(root_folder, "buffers")
    mesh_path = os.path.join(root_folder, 'buffers/1.obj')
